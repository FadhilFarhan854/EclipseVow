...
const NavigationFAB = () => {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50 flex flex-col items-end pointer-events-none">
      ...
      <button
        onClick={toggleMenu}
        className="w-12 h-12 rounded-full bg-card border border-border flex items-center justify-center text-primary hover:bg-primary hover:text-background transition-all duration-300 box-glow-hover group pointer-events-auto"
